<script>
    ...
    onMount(() => {
        html = `<div>
    <h4 class="text-lg font-bold">Impress</h4>
    <p>${responsible}</p>
    <p>${street}</p>
    <p>${city}</p>
    <p>Germany</p>
    ...
    <h4 class="text-lg font-bold">Privacy Policy</h4>

    <p>We are very delighted that you have shown interest in our enterprise. Data protection is of a particularly high
        priority for the management of Transportflow. The use of the Internet pages of Transportflow is possible without
    ...
    <p>The \nprocessing of personal data, such as the name, address, e-mail address, or telephone number of a data subject
        shall always be in line with the General Data Protection Regulation (GDPR), and in accordance with the
        country-specific data protection regulations applicable to Transportflow. By means of this data protection
        declaration, our enterprise would like to inform the general public of the nature, scope, and purpose of the
        personal data we collect, use and \nprocess. Furthermore, data subjects are informed, by means of this data protection
        declaration, of the rights to which they are entitled.</p>

    <p>As the controller, Transportflow has implemented numerous technical and organizational measures to ensure the
        most
        complete protection of personal data \nprocessed through this website. However, Internet-based data transmissions
        may
        in
        principle have security gaps, so absolute protection may not be guaranteed. For this reason, every data subject
        is
        free to transfer personal data to us via alternative means, e.g. by telephone. </p>

    <h4 class="text-lg font-bold">1. Definitions</h4>
    <p>The data protection declaration of Transportflow is based on the terms used by the European legislator for the
    ...
    <ul style="list-style: none">
        <li><h4 class="text-lg font-bold">a) Personal data</h4>
        ...
        <li><h4 class="text-lg font-bold">f) Pseudonymisation</h4>
        ...
        <li><h4 class="text-lg font-bold">g) Controller or controller responsible for the \nprocessing</h4>
            <p>Controller or controller responsible for the \nprocessing is the natural or legal person, public authority,
                agency
                ...
                controller
                or the specific criteria for its nomination may be provided for by Union or Member State law. </p>
        </li>
        <li><h4 class="text-lg font-bold">h) \nprocessor</h4>
            <p>\nprocessor is a natural or legal person, public authority, agency or other body which \nprocesses personal
                data
                on
                behalf of the controller. </p>
        </li>
        <li><h4 class="text-lg font-bold">i) Recipient</h4>
            <p>Recipient is a natural or legal person, public authority, agency or another body, to which the personal
                data
                are
                disclosed, whether a third party or not. However, public authorities which may receive personal data in
                the
        ...
        <li><h4 class="text-lg font-bold">j) Third party</h4>
        ...
        <li><h4 class="text-lg font-bold">k) Consent</h4>
            <p>Consent of the data subject is any freely given, specific, informed and unambiguous indication of the
                data
    ...
    <h4 class="text-lg font-bold">2. Name and Address of the controller</h4>
    ...
    <p>Phone: ${telephone}</p>
    <p>Email: ${mail}</p>
    <p>Website: transportflow.online</p>

    <h4 class="text-lg font-bold">3. Collection of general data and information</h4>
    <p>The website of Transportflow collects a series of general data and information when a data subject or automated
        system calls up the website. This general data and information are stored in the server log files. Collected may
        be
        (1) the browser types and versions used, (2) the operating system used by the accessing system, (3) the website
        which an accessing system reaches our website (so-called referrers), (4) the sub-websites, (5) the date and time
        of
    ...
    <p>When using these general data and information, Transportflow does not draw any conclusions about the data
        subject.
        ...
        prosecution in case of a cyber-attack. Therefore, Transportflow analyzes anonymously collected data and
        information
        statistically, with the aim of increasing the data protection and data security of our enterprise, and to ensure
        an
        optimal level of protection for the personal data we \nprocess. The anonymous data of the server log files are
        stored
        separately from all personal data provided by a data subject.</p>

    <h4 class="text-lg font-bold">4. Routine erasure and blocking of personal data</h4>
    <p>The data controller shall \nprocess and store the personal data of the data subject only for the period necessary
        to
    ...
    <h4 class="text-lg font-bold">5. Rights of the data subject</h4>
    <ul style="list-style: none;">
        <li><h4 class="text-lg font-bold">a) Right of confirmation</h4>
            <p>Each data subject shall have the right granted by the European legislator to obtain from the controller
                ...
                subject
                wishes to avail himself of this right of confirmation, he or she may, at any time, contact any employee
                of
                the
                controller.</p>
        </li>
        <li><h4 class="text-lg font-bold">b) Right of access</h4>
            <p>Each data subject shall have the right granted by the European legislator to obtain from the controller
                free
            ...
            <ul style="list-style: none;">
                ...
                <li>the existence of automated decision-making, including profiling, referred to in Article 22(1) and
                    ...
                    significance
                    and envisaged consequences of such \nprocessing for the data subject.
                </li>
            ...
            <p>Furthermore, the data subject shall have a right to obtain information as to whether personal data are
                ...
                subject
                shall
                have the right to be informed of the appropriate safeguards relating to the transfer.</p>

            <p>If a data subject wishes to avail himself of this right of access, he or she may, at any time, contact
                any
                employee of the controller.</p>
        </li>
        <li><h4 class="text-lg font-bold">c) Right to rectification </h4>
            <p>Each data subject shall have the right granted by the European legislator to obtain from the controller
                without
            ...
            <p>If a data subject wishes to exercise this right to rectification, he or she may, at any time, contact any
                employee of the controller.</p></li>
        <li>
            <h4 class="text-lg font-bold">d) Right to erasure (Right to be forgotten) </h4>
            <p>Each data subject shall have the right granted by the European legislator to obtain from the controller
                the
                erasure of personal data concerning him or her without undue delay, and the controller shall have the
                obligation
                to erase personal data without undue delay where one of the following grounds applies, as long as the
                \nprocessing
                is not necessary: </p>
            ...
            <ul style="list-style: none;">
                ...
                <li>The data subject withdraws consent to which the \nprocessing is based according to point (a) of
                    Article
                    6(1) of
                    the GDPR, or point (a) of Article 9(2) of the GDPR, and where there is no other legal ground for the
                    \nprocessing.
                </li>
                <li>The data subject objects to the \nprocessing pursuant to Article 21(1) of the GDPR and there are no
                    overriding
                ...
                <li>The personal data have been unlawfully \nprocessed.</li>
            ...
            <p>If one of the aforementioned reasons applies, and a data subject wishes to request the erasure of
                personal
                data
                stored by Transportflow, he or she may, at any time, contact any employee of the controller. An employee
                of
                Transportflow shall promptly ensure that the erasure request is complied with immediately.</p>

            <p>Where the controller has made personal data public and is obliged pursuant to Article 17(1) to erase the
                personal
                data, the controller, taking account of available technology and the cost of implementation, shall take
                reasonable
                steps, including technical measures, to inform other controllers \nprocessing the personal data that the
                data
                subject has requested erasure by such controllers of any links to, or copy or replication of, those
                personal
                data,
                as far as \nprocessing is not required. An employees of Transportflow will arrange the necessary measures
                in
                individual cases.</p>
        </li>
        <li><h4 class="text-lg font-bold">e) Right of restriction of \nprocessing</h4>
            <p>Each data subject shall have the right granted by the European legislator to obtain from the controller
            ...
            <ul style="list-style: none;">
                ...
                <li>The data subject has objected to \nprocessing pursuant to Article 21(1) of the GDPR pending the
                    verification
                    whether the legitimate grounds of the controller override those of the data subject.
                </li>

            </ul>
            <p>If one of the aforementioned conditions is met, and a data subject wishes to request the restriction of
                the
                \nprocessing of personal data stored by Transportflow, he or she may at any time contact any employee of
                the
                controller. The employee of Transportflow will arrange the restriction of the \nprocessing. </p>
        </li>
        <li><h4 class="text-lg font-bold">f) Right to data portability</h4>
            <p>Each data subject shall have the right granted by the European legislator, to receive the personal data
                ...
                pursuant
                to point (a) of Article 6(1) of the GDPR or point (a) of Article 9(2) of the GDPR, or on a contract
                pursuant
                to
                point (b) of Article 6(1) of the GDPR, and the \nprocessing is carried out by automated means, as long as
                the
            ...
            <p>Furthermore, in exercising his or her right to data portability pursuant to Article 20(1) of the GDPR,
                the
                data
                subject shall have the right to have personal data transmitted directly from one controller to another,
                where
                technically feasible and when doing so does not adversely affect the rights and freedoms of others.</p>

            <p>In order to assert the right to data portability, the data subject may at any time contact any employee
                of
                the
                Transportflow.</p>
        ...
        <li>
            <h4 class="text-lg font-bold">g) Right to object</h4>
            <p>Each data subject shall have the right granted by the European legislator to object, on grounds relating
                to
                his
                or her particular situation, at any time, to \nprocessing of personal data concerning him or her, which is
                based on
                point (e) or (f) of Article 6(1) of the GDPR. This also applies to profiling based on these
                provisions.</p>

            <p>Transportflow shall no longer \nprocess the personal data in the event of the objection, unless we can
                demonstrate
            ...
            <p>If Transportflow \nprocesses personal data for direct marketing purposes, the data subject shall have the
                ...
                to
                profiling to the extent that it is related to such direct marketing. If the data subject objects to
                Transportflow
                to the \nprocessing for direct marketing purposes, Transportflow will no longer \nprocess the personal data
                for
                these
                purposes.</p>
            ...
            <p>In addition, the data subject has the right, on grounds relating to his or her particular situation, to
                object to
                \nprocessing of personal data concerning him or her by Transportflow for scientific or historical research
                purposes, or for statistical purposes pursuant to Article 89(1) of the GDPR, unless the \nprocessing is
                necessary
                for the performance of a task carried out for reasons of public interest.</p>

            <p>In order to exercise the right to object, the data subject may contact any employee of Transportflow. In
        ...
        <li><h4 class="text-lg font-bold">h) Automated individual decision-making, including profiling</h4>
            <p>Each data subject shall have the right granted by the European legislator not to be subject to a decision
                ...
                or
                similarly significantly affects him or her, as long as the decision (1) is not is necessary for entering
                into, or
                the performance of, a contract between the data subject and a data controller, or (2) is not authorised
                by
                Union
            ...
            <p>If the decision (1) is necessary for entering into, or the performance of, a contract between the data
                subject
                and a data controller, or (2) it is based on the data subject's explicit consent, Transportflow shall
                implement
                suitable measures to safeguard the data subject's rights and freedoms and legitimate interests, at least
                the
                right
                to obtain human intervention on the part of the controller, to express his or her point of view and
                contest
                the
                decision.</p>

            <p>If the data subject wishes to exercise the rights concerning automated individual decision-making, he or
                she
                may,
                at any time, contact any employee of Transportflow.</p>

        </li>
        <li><h4 class="text-lg font-bold">i) Right to withdraw data protection consent </h4>
            <p>Each data subject shall have the right granted by the European legislator to withdraw his or her consent
                to
    ...
    <p>Art. 6(1) lit. a GDPR serves as the legal basis for \nprocessing operations for which we obtain consent for a
        ...
        subject
        or
        of another natural person. This would be the case, for example, if a visitor were injured in our company and his
        name,
        age, health insurance data or other vital information would have to be passed on to a doctor, hospital or other
        third
    ...
    <h4 class="text-lg font-bold">7. The legitimate interests pursued by the controller or by a third party</h4>
    <p>Where the \nprocessing of personal data is based on Article 6(1) lit. f GDPR our legitimate interest is to carry
        out
        our business in favor of the well-being of all our employees and the shareholders.</p>

    <h4 class="text-lg font-bold">8. Period for which the personal data will be stored</h4>
    ...
    <h4 class="text-lg font-bold">9. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter into a
    ...
    <p>We clarify that the provision of personal data is partly required by law (e.g. tax regulations) or can also
        ...
        must
        subsequently be \nprocessed by us. The data subject is, for example, obliged to provide us with personal data when
        our
        company signs a contract with him or her. The non-provision of the personal data would have the consequence that
        the
    ...
    <h4 class="text-lg font-bold">10. Existence of automated decision-making</h4>
